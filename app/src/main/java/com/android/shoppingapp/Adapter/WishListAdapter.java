...
public class WishListAdapter extends RecyclerView.Adapter<WishListAdapter.ViewHolder> {
    ...
    List<WishListPojo.Data> dataList = new ArrayList<>();
    ...
    public WishListAdapter(Context context, List<WishListPojo.Data> foodLists, RelativeLayout parentLayout) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_wish, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        WishListPojo.Data data = dataList.get(position);
        ...
        if (data.getIsCart() > 0) {
            ...
            holder.listProdRemoveTxt.setVisibility(View.VISIBLE);
        } else {
            holder.addCartTxt.setText("Add");
            holder.listProdRemoveTxt.setVisibility(View.GONE);
        }
