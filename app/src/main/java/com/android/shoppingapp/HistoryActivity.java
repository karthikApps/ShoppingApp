...
import com.android.shoppingapp.Adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    private ArrayList<HistoryPojo.Data> prodList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new HistoryAdapter(this, prodList);
    ...
    private void jsonHistoryList() {

        CommonFunctions.showProgressDialog(this);

        if (CommonFunctions.isGPSEnabled(this)) {
            Call<HistoryPojo> call = apiInterface.getHistory(sessionManager.getHeader());
    ...
    public void actionBar() {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#F3807A'>My Orders </font>"));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
